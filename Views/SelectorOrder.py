...
def ReturnSelectorView(parent):
    ventana = tk.Frame(parent, bg='#288BA8')  # Color de fondo en formato hexadecimal
    ...
    # Label de bienvenida
    lbl = tk.Label(ventana, text="Vista de selector", bg='#596174', bd=5, relief="solid", font=("Helvetica", 18))
